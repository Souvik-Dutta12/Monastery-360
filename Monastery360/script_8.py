# Create Researcher-specific JavaScript
researcher_js = '''// Researcher Dashboard JavaScript
...
with open('js/researcher.js', 'w', encoding='utf-8') as f:
    f.write(researcher_js)

print("✅ Researcher JavaScript (js/researcher.js) created successfully!")